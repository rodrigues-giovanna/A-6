...
<body>
    ...
    if(isset($_POST['nome']) && isset($_POST['resposta1']) && isset($_POST['resposta2']) && isset($_POST['resposta3']) && isset($_POST['resposta4']) && isset($_POST['resposta5'])) {
        $nome = $_POST['nome'];
        $resposta1 = strtolower(string: $_POST['resposta1']);
        $resposta2 = strtolower(string: $_POST['resposta2']);
        $resposta3 = strtolower(string: $_POST['resposta3']);
        $resposta4 = strtolower(string: $_POST['resposta4']);
        $resposta5 = strtolower(string: $_POST['resposta5']);
